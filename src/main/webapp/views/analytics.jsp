...
<body class="text-gray-200 min-h-screen premium-gradient">
    ...
    <main class="md:ml-64 p-4 pt-20 md:pt-8 lg:p-12">
        <div class="mb-12">
            <h1 class="text-2xl md:text-4xl font-bold text-white tracking-tight">Advanced Analytics</h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="glass-card p-6 rounded-3xl">
                ...
                <h2 class="text-xl md:text-3xl font-bold text-white mt-2"><fmt:formatNumber value="${weeklyComparison.totalSpent}" type="currency" currencySymbol="$"/></h2>
            </div>
            <div class="glass-card p-6 rounded-3xl">
                <p class="text-gray-400 text-sm">Daily Average</p>
                <h2 class="text-xl md:text-3xl font-bold text-yellow-400 mt-2"><fmt:formatNumber value="${weeklyComparison.dailyAverage}" type="currency" currencySymbol="$"/></h2>
            </div>
            <div class="glass-card p-6 rounded-3xl">
                <p class="text-gray-400 text-sm">MoM Change</p>
                <h2 class="text-xl md:text-3xl font-bold ${trends.monthOverMonthChange >= 0 ? 'text-red-400' : 'text-green-400'} mt-2">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div class="glass-card p-8 rounded-3xl">
                <h3 class="text-lg md:text-xl font-bold text-white mb-6">Top Categories</h3>
                <div class="relative h-64">
                    <canvas id="topCategoriesChart"></canvas>
                </div>
            </div>
            <div class="glass-card p-8 rounded-3xl">
                <h3 class="text-lg md:text-xl font-bold text-white mb-6">6-Month Trend</h3>
                <div class="relative h-64">
        ...
        <div class="glass-card p-8 rounded-3xl">
            <h3 class="text-lg md:text-xl font-bold text-white mb-6">Top Spending Categories</h3>
            <div class="space-y-4">
