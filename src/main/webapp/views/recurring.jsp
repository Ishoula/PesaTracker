...
<body class="text-gray-200 min-h-screen premium-gradient">
    ...
    <main class="ml-64 p-8 lg:p-12">
        <div class="flex justify-between items-center mb-12">
            <div>
                <h1 class="text-4xl font-bold text-white tracking-tight">Recurring Expenses</h1>
        ...
        <div class="glass-card p-8 rounded-3xl mb-8">
            <h3 class="text-xl font-bold text-white mb-6">Create Recurring Expense</h3>
        ...
        <div class="glass-card p-8 rounded-3xl">
            <h3 class="text-xl font-bold text-white mb-6">Active Recurring Expenses</h3>
            <div class="space-y-4">
    ...
    <script>lucide.createIcons(); document.querySelector('input[name=startDate]').valueAsDate = new Date();</script>
</body>
</html>
