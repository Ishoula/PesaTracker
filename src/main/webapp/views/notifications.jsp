...
<body class="text-gray-200 min-h-screen premium-gradient">
    ...
    <main class="md:ml-64 p-4 pt-20 md:pt-8 lg:p-12">
        <div class="flex justify-between items-center mb-12">
            <div>
                <h1 class="text-2xl md:text-4xl font-bold text-white tracking-tight">Notifications</h1>
        ...
        <div class="glass-card p-8 rounded-3xl">
            <div class="flex items-center justify-between mb-6">
                <h3 class="text-lg md:text-xl font-bold text-white">Your Notifications</h3>
