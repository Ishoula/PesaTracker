...
<head>
    ...
    <title>Register | PesaTracker</title>
    ...
    <div class="relative w-full max-w-md glass-card p-10 rounded-[2.5rem] animate-fade">
        ...
        <div class="flex flex-col items-center mb-10 text-center">
            <div class="w-16 h-16 bg-yellow-400 rounded-2xl flex items-center justify-center shadow-[0_0_40px_rgba(250,204,21,0.3)] mb-6">
                <i data-lucide="user-plus" class="text-black w-10 h-10"></i>
            </div>
            <h2 class="text-4xl font-bold text-white tracking-tight">Join Us</h2>
            <p class="text-gray-400 mt-2 font-light">Start Tracking Your Wealth Today</p>
        </div>
        ...
        <form action="<c:url value='/auth/register'/>" method="POST" class="space-y-6">
        ...
        <div class="text-center mt-10">
            <p class="text-gray-500 text-sm">
                ...
                <a href="<c:url value='/auth/login'/>" class="text-yellow-400 font-bold hover:underline ml-1">
                    Sign In
                </a>
            </p>
        </div>
